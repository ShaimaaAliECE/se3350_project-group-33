					...
					<DndProvider backend={HTML5Backend}>
						<div className="flex flex-col justify-center">
							<div className="flex  justify-center">
								...
								<p className=" w-max  p-2 rounded-xl bg-blue-200 m-2">
									Therefore Array devided into 2 parts
								</p>
								<p className=" w-max  p-2 rounded-xl bg-blue-200 m-2">
						...
						<div className="flex gap-4 mb-4">
							<div className="flex items-center  gap-2 flex-col">
								<div className="w-50 bg-blue-200 p-2 rounded-xl">
									<p>
										Array has 2 elements {numbers[0]} and {numbers[1]}
									</p>
									<p>Half = Length/2 = 1</p>
									<p>
										{numbers[0]} and {numbers[1]} are divided into 2 arrays
									</p>
								</div>
							...
							<div className="flex items-center  gap-2 flex-col">
								<div className="w-50 bg-blue-200 p-2 rounded-xl">
									<p>
										Array has 3 elements {numbers[2]}, {numbers[3]}and{" "}
										{numbers[4]}
									</p>
									<p>Half = Length/2 = 1.5</p>
									<p>
										{numbers[2]}, {numbers[3]} and {numbers[4]} are divided into
										2 arrays
									</p>
								</div>
								<div className="flex gap-4">
							...
							<div className="flex items-center  gap-2 flex-col">
								<div className="w-50 bg-blue-200 p-2 rounded-xl">
									<p>
										Array has 2 elements {numbers[5]} and {numbers[6]}
									</p>
									<p>Half = Length/2 = 1</p>
									<p>
										{numbers[5]} and {numbers[6]} are divided into 2 arrays
									</p>
								</div>
								<div className="flex gap-4">
							...
							<div className="flex items-center  gap-2 flex-col">
								<div className="w-50 bg-blue-200 p-2 rounded-xl">
									<p>
										Array has 3 elements {numbers[7]}, {numbers[8]}and{" "}
										{numbers[9]}
									</p>
									<p>Half = Length/2 = 1.5</p>
									<p>
										{numbers[7]}, {numbers[8]} and {numbers[9]} are divided into
										2 arrays
									</p>
								</div>
								<div className="flex gap-4">
					...
					<div className="flex flex-col items-center gap-3">
						<div className="flex gap-2">
							<div className=" bg-blue-200 p-2 rounded-xl mb-4">
								Array consisting of elements{" "}
								<span className="font-bold"> {numbers[3]}</span> and
								<span className="font-bold"> {numbers[4]}</span> will be further
								divided
							</div>

							<div className=" bg-blue-200 p-2 rounded-xl mb-4">
								Array consisting of elements{" "}
								<span className="font-bold"> {numbers[8]}</span> and
								<span className="font-bold"> {numbers[9]}</span> will be further
								divided
							</div>
						</div>
					</div>
							...
							<div className="flex flex-col ">
								<div className="flex ">
									<div
										className={
											showNextElement == 1
												? "flex flex-col p-2 bg-blue-200 rounded-2xl opacity-100"
